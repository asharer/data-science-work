...
```{r scatterplot of consumption and co2 by country}
df_food_pop %>%
  ggplot() +
...
[Food consumption data, original source](https://www.nu3.de/blogs/nutrition/food-carbon-footprint-index-2018)
